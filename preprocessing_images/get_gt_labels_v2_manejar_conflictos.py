...
def get_Dataframe_of_sentences(dataframe_of_words,min_words=7,max_words=14,small_possible_number_of_words=4):
...
Dataframe_of_sentences=get_Dataframe_of_sentences(dataframe_of_words,min_words=7,max_words=14,small_possible_number_of_words=4)
