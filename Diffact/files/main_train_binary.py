...
class Trainer:
    ...
    def test(self, test_dataset, mode, device, label_dir, logger,epoch,loss_weights,pos_weight,result_dir=None, model_path=None):
        ...
        # logger.add_scalar(f'Comparison/Train_vs_Test_F1B/Test_F1B_per_epoch', epoch_running_loss_f1b, epoch)
        # logger.add_scalar(f'Train_vs_Test/Test_F1S', epoch_running_loss_f1s, epoch)
...
if __name__ == '__main__':
    ...
    result_dir=os.path.join("/media/iot/ML/Summy/final_version_organized/DiffAct/train_layers_last_layer",dataset_name,'break_decoder_12_256_1')
